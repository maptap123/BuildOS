...
export async function updateSession(request: NextRequest) {
  ...
  //
  // /auth/* and /welcome carry the invited user before they have a session — bouncing
  // them to /login would also drop the URL fragment Supabase's own mailer returns the
  // session in, since a fragment is never sent to the server.
