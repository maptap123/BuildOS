...
export function EstimateBuilderClient({
  ...
  // ── Hand the estimate to Fixer ─────────────────────────────────
  // Fixer prices from JDC's own past estimates via its find_comparable_estimates
  // and add_estimate_lines tools, so the drafting happens in the assistant the
  // rest of the app uses rather than in a separate model behind this button.
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                {permissions.can_create && !activeEstimate.is_locked && (
                  <button
                    onClick={askFixerToDraft}
                    title="Fixer prices it from past JDC jobs"
